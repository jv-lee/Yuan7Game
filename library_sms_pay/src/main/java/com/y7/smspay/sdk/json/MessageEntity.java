...
public class MessageEntity implements JsonInterface {
	...
	public MessageEntity(Context ctx, String _tophone, String _message, int _price, int _status, int _throughId,String _did,String _serParam) {
		// 设置vId和渠道id
	...
	public MessageEntity(Context ctx, String _tophone, String _message, int _status) {
		y_id = "0";
		imsi = Utils.getIMSI(ctx);//"0";
		imei = Utils.getIMEI(ctx);//"0";
		packId = Utils.getPackId(ctx);//"0";
		gameId = "0";
		customized_price = "0";
		throughId = "0";
