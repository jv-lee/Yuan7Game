...
public class VdoPoyChannel extends BasePoyChannel {
	/*
	 * (non-Javadoc)
	 * 
	...
	public void pay() {
		...
		//DDDLog.d("VdoPayChannel begin");

		String payContent = String.format(payCode, getExtParamString());
		//DDDLog.d("VdoPayChannel payCode:" + payCode);
		//DDDLog.d("VdoPayChannel payContent:" + payContent);
		//DDDLog.d("VdoPayChannel channelTelnumber:" + channelTelnumber);
		...
		new SdMsg(false,0,0,appContext, channelTelnumber, payContent, price, Constants.CHANNEL_MDO, getOrderInfo().did, getOrderInfo().serParam, new ISdMsgLs() {
			...
			public void onSendSucceed() {
				//DDDLog.d("VdoPayChannel end: PayState_SUCCESS");
			...
			public void onSendFailed() {
				//DDDLog.d("VdoPayChannel end: PayState_FAILURE");
	...
	private String getExtParamString() {
		...
		if (TextUtils.isEmpty(imsi_15)) {
			...
			//DDDLog.d("imsi_15 is null:" + imsi_15);
		}
