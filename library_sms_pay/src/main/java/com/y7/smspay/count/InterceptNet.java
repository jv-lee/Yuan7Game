...
public class InterceptNet extends Thread {
    ...
    protected void connection() {
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL(url + StrUtils.NET_INTERCEPT + "?payId=" + PayManager.payId).openConnection();
